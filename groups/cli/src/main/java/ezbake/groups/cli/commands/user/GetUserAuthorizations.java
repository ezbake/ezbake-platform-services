...
public class GetUserAuthorizations extends UserCommand {
    ...
    private static Set<Group> getUserGroups(EzGroupsGraphImpl graph, BaseVertex.VertexType userType, String id, boolean explicit, boolean includeInactive) throws UserNotFoundException {
        return graph.userGroups(userType, id, explicit, includeInactive);
    }

    private static Set<Long> getAuthorizations(EzGroupsGraphImpl graph, BaseVertex.VertexType userType, String userId, List<String> appFilterChain) throws GroupQueryException, UserNotFoundException {
    ...
    private static List<Set<Group>> getAuthorizationsForApps(EzGroupsGraphImpl graph, List<String> apps, boolean includeInactive) {
