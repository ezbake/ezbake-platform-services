...
public class ArtifactHelpers {
    ...
    public static ArtifactTypeKey getTypeKey(DeploymentArtifact deploymentArtifact) {
        return new ArtifactTypeKey(getType(deploymentArtifact), getLanguage(deploymentArtifact));
    }
