...
public class EzSecurityITBase {
    ...
    public static void setUpServerPool() throws Exception {
        ...
        serverPool.startCommonService(
                new EzSecurityHandler(), EzSecurityServicesConstants.SECURITY_SERVICE_NAME, "12345");
        serverPool.startCommonService(
                new ezbake.groups.service.EzBakeThriftService(), EzGroupsConstants.SERVICE_NAME, "12345");
