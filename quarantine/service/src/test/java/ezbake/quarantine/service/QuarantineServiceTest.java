...
public class QuarantineServiceTest {
    ...
    public static void setup() throws AccumuloSecurityException, AccumuloException, TableExistsException, TableNotFoundException, NamespaceExistsException, InterruptedException, TException {
        ...
        when(mockClient.getGroupsMask(
                fouoToken, appSet, Collections.<String>emptySet(), Collections.<String>emptySet())
        ).thenReturn(groupsMask);
        when(mockClient.getGroupsMask(
                communitiesToken, appSet, Collections.<String>emptySet(), Collections.<String>emptySet())
        ).thenReturn(groupsMask);
        when(mockClient.getGroupsMask(
                secretToken, appSet, Collections.<String>emptySet(), Collections.<String>emptySet())
        ).thenReturn(groupsMask);
        when(mockClient.getGroupsMask(
                otherIdToken, appSet, Collections.<String>emptySet(), Collections.<String>emptySet())
        ).thenReturn(groupsMask);
        when(mockClient.getGroupsMask(
                fouoToken, otherAppSet, Collections.<String>emptySet(), Collections.<String>emptySet())
